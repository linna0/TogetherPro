...
<%--                    </form>--%>
<%--&lt;%&ndash;                    <div class="drafts"><p class="view-all"><a&ndash;%&gt;--%>
<%--&lt;%&ndash;                            href="/admin/article"&ndash;%&gt;--%>
<%--&lt;%&ndash;                            aria-label="查看所有草稿">查看所有</a></p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <h2 class="hide-if-no-js">草稿</h2>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <c:forEach items="${articleList}" var="a">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <c:if test="${a.articleStatus==0}">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        <div class="draft-title"><a&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                href="/admin/article/edit/${a.articleId}">${a.articleTitle}</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                            <time ><fmt:formatDate value="${a.articleCreateTime}" pattern="yyyy年MM月dd日"/></time>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </c:if>&ndash;%&gt;--%>
